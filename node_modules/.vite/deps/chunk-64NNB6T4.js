...
var init_dataTables_buttons = __esm({
  "node_modules/datatables.net-buttons/js/dataTables.buttons.mjs"() {
    ...
    _instCounter = 0;
    _buttonCounter = 0;
    _dtButtons = dataTables_default.ext.buttons;
    _entityDecoder = null;
      ...
      */
      ...
      _buildButton: function(config, inCollection, isSplit, inSplit) {
        ...
        if (!config.html) {
          ...
          button = $("<" + tag + "/>").addClass(dom.className).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(e) {
            e.preventDefault();
          ...
          if (dom.liner.tag) {
            ...
            var liner = $("<" + lc + "/>").html(text(config.text)).addClass(dom.liner.className);
            if (lc === "a") {
              liner.attr("href", "#");
            }
            if (lc === "a" || lc === "button") {
    ...
    _stringOrFunction = function(option, config, dt) {
    ...
    _message = function(dt, config, option, position) {
    ...
    dataTables_buttons_default = dataTables_default;
  }
});
...
datatables.net-buttons/js/dataTables.buttons.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-64NNB6T4.js.map
